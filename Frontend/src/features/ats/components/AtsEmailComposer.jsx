    ...
    <div className="ats-email">
      {success && (
        <div className="ats-email__success" role="status">
          <span className="ats-email__success-icon"><IconCheck /></span>
          <span>{success}</span>
        </div>
      )}
      ...
      >
        <span className="ats-email__trigger-icon"><IconMail size={16} /></span>
        ...
        >
          <div className="ats-email__modal" role="dialog" aria-modal="true" aria-labelledby="ats-email-title">
            <div className="ats-email__header">
              ...
              <button type="button" className="ats-email__close" onClick={close} disabled={sending} aria-label="Close email composer">
                <IconX />
              </button>
            </div>
            ...
            <form onSubmit={submit} className="ats-email__form">
              <div className="ats-email__fields">
                <label className="ats-email__field ats-email__field--full">
              ...
              <div className="ats-email__attachments" role="radiogroup" aria-label="Resume attachment">
                ...
                >
                  ...
                  <span className="ats-email__attachment-copy">
                    ...
                    <small>{hasRevision ? "Your latest AI-improved PDF" : "Generate an AI revision to unlock"}</small>
                  </span>
              ...
              <div className="ats-email__security-note">
                <IconCheck /> <span>Your resume is sent as a PDF attachment. Nothing is downloaded to your device first.</span>
              </div>
              ...
              <div className="ats-email__actions">
                ...
                <button type="submit" className="ats-email__send" disabled={sending}>
                  {sending ? <span className="ats-email__spinner" /> : <IconMail size={16} />}
