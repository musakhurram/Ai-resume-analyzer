...
const AtsScoreOverview = ({ analysis, fileName, onFixClick }) => {
    ...
    <div className="ats-score-overview glass-panel">
      <div className="ats-score-overview__main">
        ...
        <div className="ats-score-overview__details">
          <div className="ats-score-overview__eyebrow-row">
            <span className="eyebrow">ATS READINESS BENCHMARK</span>
          ...
          <div className="ats-score-overview__chips">
            <div className="ats-score-overview__chip">
              <span className="ats-score-overview__chip-label">ATS Compatibility Subscore:</span>
              <span className="ats-score-overview__chip-val">{atsCompatibility.score}%</span>
            </div>
            <div className="ats-score-overview__chip">
              <span className="ats-score-overview__chip-label">Total Parsing Flags:</span>
            ...
            {highCount > 0 && (
              <div className="ats-score-overview__chip ats-score-overview__chip--danger">
                ...
                <span>{highCount} Critical Blockers</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="ats-score-overview__action-col">
          <button
            type="button"
            className="ats-score-overview__fix-btn button button--primary button--lg"
            onClick={onFixClick}
          >
          ...
          <span className="ats-score-overview__fix-note">Rewrite into clean ATS PDF</span>
        </div>
      </div>
      ...
      <div className="ats-score-overview__stat-strip">
        <div className="ats-stat-item">
          ...
          <span className="ats-stat-item__label">High Severity</span>
        </div>
        <div className="ats-stat-item">
          <span className="ats-stat-item__num ats-stat-item__num--med">{medCount}</span>
          <span className="ats-stat-item__label">Medium Severity</span>
        </div>
        <div className="ats-stat-item">
          <span className="ats-stat-item__num ats-stat-item__num--low">{lowCount}</span>
          <span className="ats-stat-item__label">Low Severity</span>
        </div>
        <div className="ats-stat-item">
          <span className="ats-stat-item__num ats-stat-item__num--accent">
            {analysis?.strengths?.length || 0}
          </span>
          <span className="ats-stat-item__label">Key Strengths</span>
        </div>
      </div>
    </div>
  );
