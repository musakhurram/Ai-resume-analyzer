...
const atsReportSchema = new mongoose.Schema(
  {
    ...
    analysis: {
      ...
      scoreBreakdown: {
        atsCompatibility: atsScoreBreakdownItemSchema,
        contactInfo: atsScoreBreakdownItemSchema,
        summary: atsScoreBreakdownItemSchema,
        experience: atsScoreBreakdownItemSchema,
        skills: atsScoreBreakdownItemSchema,
        education: atsScoreBreakdownItemSchema,
        formatting: atsScoreBreakdownItemSchema,
      },
      atsCompatibility: {
