...
const { generateAtsEmailController } = require("../controllers/emailApplication.controller");
...
atsRouter.post("/ats-send-email", authUser, sendAtsEmailController);
atsRouter.post("/ats-generate-email", authUser, aiGenerationLimiter, generateAtsEmailController);
